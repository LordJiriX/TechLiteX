...
public class TLXJEIPlugin implements IModPlugin {
    ...
    public static final ResourceLocation UID =
            new ResourceLocation(MODID, "jei_plugin");
    ...
    public void registerCategories(IRecipeCategoryRegistration registration) {
        ...
        registration.addRecipeCategories(
                new MultiInOutCategory.Separator(
                        registration.getJeiHelpers().getGuiHelper()
                )
        );
        registration.addRecipeCategories(
                new MultiInOutCategory.Greenhouse(
                        registration.getJeiHelpers().getGuiHelper()
                )
        );
    }
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        registration.addRecipes(
                ...
                TLXData.grinderRecipes
        );
        registration.addRecipes(
                MultiInOutCategory.Greenhouse.TYPE_A,
                TLXData.greenHouseRecipes
        );
        registration.addRecipes(
                MultiInOutCategory.Separator.TYPE_B,
                TLXData.separatorRecipes
        );
    }
    ...
    public void registerRecipeCatalysts(IRecipeCatalystRegistration registration) {
        ...
        registration.addRecipeCatalyst(
                new ItemStack(TLXBlocks.GRINDER_BLOCK_2.get()),
                GrinderCategory.TYPE
        );
        /*registration.addRecipeCatalyst(
                new ItemStack(TLXBlocks.GRINDER_BLOCK_1.get()),
        ...
        registration.addRecipeCatalyst(
                new ItemStack(TLXBlocks.SEPARATOR_BLOCK_1.get()),
                MultiInOutCategory.Separator.TYPE_B
        );
        registration.addRecipeCatalyst(
                new ItemStack(TLXBlocks.GREENHOUSE_BLOCK_1.get()),
                MultiInOutCategory.Greenhouse.TYPE_A
        );
    }
}