...
public class CokeOvenBlockEntity extends BlockEntity implements MenuProvider {
  ...
  public int timeToRunRecipe = RCData.timePerCokeOvenRecipe;
  ...
  public CokeOvenBlockEntity(BlockPos pPos, BlockState pBlockState) {
    super(RCBlockEntitys.COKE_OVEN_BLOCK_ENTITY.get(), pPos, pBlockState);
  }
    ...
    public void tick() {
        ...
        if (currentRunTime >= timeToRunRecipe) {
            ...
            inventory.insertItem(1, new ItemStack(RCItems.COAL_COKE.get(), 1), false);
            currentRunTime = 0;
            setChanged();
        }
    }
  ...
  public void invalidateCaps() {
    ...
    public boolean isMultiblockValid(BlockPos pos) {
        ...
        Block brick = RCBlocks.COKE_OVEN_BRICK_BLOCK.get();
        Block firebox = RCBlocks.COKE_OVEN_FIREBOX.get();
